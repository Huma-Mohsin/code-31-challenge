...
//solution
function findAndReplace(fruit_basket_contains) {
    var finding_index = fruit_basket_contains.indexOf("Banana");
    if (finding_index !== -1) {
        fruit_basket_contains[finding_index] = "Mango";
    }
}
var fruit_basket_contains = ["Apple", "Orange", "Kiwi", "Banana", "Cherry", "strawberry"];
